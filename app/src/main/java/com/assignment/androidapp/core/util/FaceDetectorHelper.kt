...
class FaceDetectorHelper(
    ...
    interface DetectorListener {
        ...
        // Add this for Compose state management
        val detectionState: State<DetectionState>
...
sealed class DetectionState {
    ...
    data class Detecting(val result: FaceDetectorHelper.ResultBundle) : DetectionState()
    data class Error(val message: String, val code: Int) : DetectionState()
}